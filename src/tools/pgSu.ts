...
const pgSuFormSections: FormSectionConfig[] = [
  {
    ...
    inputs: [
      ...
      {
        id: 'pg_su_major_biopsy_exclusion',
        label: 'Other causes of cutaneous ulceration have been excluded',
        type: 'select',
        options: commonYesNoOptions,
        defaultValue: 0,
        validation: getValidationSchema('select', commonYesNoOptions),
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        label: 'History of systemic diseases associated with PG (IBD, RA, paraproteinemia)',
        type: 'select',
        options: commonYesNoOptions,
        defaultValue: 0,
        validation: getValidationSchema('select', commonYesNoOptions),
      ...
      {
        id: 'pg_su_minor_histo',
        label: 'Histopathology (Neutrophilic infiltrate, +/- vasculitis)',
        type: 'select',
        options: commonYesNoOptions,
        defaultValue: 0,
        validation: getValidationSchema('select', commonYesNoOptions),
