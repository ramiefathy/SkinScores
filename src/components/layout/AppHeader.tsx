...
export function AppHeader({ isMobile }: { isMobile: boolean }) {
    ...
    return (
        <header className="sticky top-0 z-20 flex h-auto min-h-[4rem] items-start gap-2 border-b bg-background/80 px-4 pt-2 pb-2 backdrop-blur-sm sm:h-16 sm:items-center sm:px-6 sm:pb-2">
