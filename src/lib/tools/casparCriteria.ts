...
export const casparCriteriaTool: Tool = {
  ...
  acronym: "CASPAR",
  description: "Classification criteria to identify Psoriatic Arthritis (PsA) in research and clinical studies. Requires inflammatory articular disease plus a score of at least 3 from five categories: psoriasis, nail lesions, negative RF, dactylitis, and radiological evidence.",
  condition: "Psoriasis / Psoriatic Arthritis",
  keywords: ["caspar", "psoriatic arthritis", "psa", "classification criteria", "dactylitis", "nail psoriasis"],
