...
const behcetFormSections: FormSectionConfig[] = [
  ...
  },
  {
    ...
    inputs: [
        ...
        { id: "behcet_skin", label: "Skin lesions (e.g., erythema nodosum, pseudofolliculitis, papulopustules)", type: 'select', options: behcetOptions, defaultValue: 0, validation: getValidationSchema('select', behcetOptions) },
...
export const behcetCriteriaTool: Tool = {
  ...
  description: "Diagnostic/classification criteria for Behçet’s disease. Requires recurrent oral ulceration (at least 3 times in 12 months) plus any two of the following: recurrent genital ulceration, eye lesions, skin lesions, or a positive pathergy test.",
