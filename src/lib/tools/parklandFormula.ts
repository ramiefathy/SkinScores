...
export const parklandFormulaTool: Tool = {
  ...
  description: "A formula to estimate the initial 24-hour fluid requirement for severe burn patients (>20% TBSA in adults, >10% in children). Formula: Total Fluid (mL) = 4 mL × Body Weight (kg) × %TBSA Burned.",
  condition: "Burns",
